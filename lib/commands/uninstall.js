...
module.exports = function uninstall(packageName) {
  ...
  Log.success(`Removed ${name}@${packageEntry.version} from install configuration.`);
  Log.warning("Note: You may need to manually remove the package from your workspace if it was linked or copied there.");
